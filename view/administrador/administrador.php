...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark orange lighten-1">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-555">
    ...
    <input type="submit" value="Reporte de inventario General" class="btn peach-gradient rounded-pill">
    </form>
    </li>
    <li>
    <a href="../productos/addproductos.php" class="btn peach-gradient rounded-pill">Agregar Producto</a>
    </li>
    </ul>
  </div>
</nav>
